...
typedef enum {
    ...
    RG_ICE_CAVERN_SILVER_RUPEE = RG_SILVER_RUPEE_FIRST, // for convenience
    ...
    RG_SILVER_RUPEE_LAST = RG_SPIRIT_MQ_LOBBY_SILVER_RUPEE, // for convenience
    RG_SILVER_RUPEE_POUCH_FIRST,
    RG_ICE_CAVERN_SILVER_RUPEE_POUCH = RG_SILVER_RUPEE_POUCH_FIRST, // for convenience
    ...
    RG_SILVER_RUPEE_POUCH_LAST = RG_SPIRIT_MQ_LOBBY_SILVER_RUPEE_POUCH, // for convenience
    RG_MAX
} RandomizerGet;
