...
std::unordered_map<RandomizerCheck, u16> scrubPrices = {
    { RC_LW_DEKU_SCRUB_NEAR_DEKU_THEATER_RIGHT, 40 },
    { RC_LW_DEKU_SCRUB_NEAR_DEKU_THEATER_LEFT, 40 },
    { RC_LW_DEKU_SCRUB_NEAR_BRIDGE, 40 },
    { RC_LW_DEKU_SCRUB_GROTTO_REAR, 40 },
    { RC_LW_DEKU_SCRUB_GROTTO_FRONT, 40 },
    { RC_SFM_DEKU_SCRUB_GROTTO_REAR, 40 },
    { RC_SFM_DEKU_SCRUB_GROTTO_FRONT, 40 },
    { RC_HF_DEKU_SCRUB_GROTTO, 40 },
    { RC_LH_DEKU_SCRUB_GROTTO_LEFT, 40 },
    { RC_LH_DEKU_SCRUB_GROTTO_RIGHT, 40 },
    { RC_LH_DEKU_SCRUB_GROTTO_CENTER, 40 },
    { RC_GV_DEKU_SCRUB_GROTTO_REAR, 40 },
    { RC_GV_DEKU_SCRUB_GROTTO_FRONT, 40 },
    { RC_COLOSSUS_DEKU_SCRUB_GROTTO_REAR, 40 },
    { RC_COLOSSUS_DEKU_SCRUB_GROTTO_FRONT, 40 },
    { RC_GC_DEKU_SCRUB_GROTTO_LEFT, 40 },
    { RC_GC_DEKU_SCRUB_GROTTO_RIGHT, 40 },
    { RC_GC_DEKU_SCRUB_GROTTO_CENTER, 40 },
    { RC_DMC_DEKU_SCRUB, 40 },
    { RC_DMC_DEKU_SCRUB_GROTTO_LEFT, 40 },
    { RC_DMC_DEKU_SCRUB_GROTTO_RIGHT, 40 },
    { RC_DMC_DEKU_SCRUB_GROTTO_CENTER, 40 },
    { RC_ZR_DEKU_SCRUB_GROTTO_REAR, 40 },
    { RC_ZR_DEKU_SCRUB_GROTTO_FRONT, 40 },
    { RC_LLR_DEKU_SCRUB_GROTTO_LEFT, 40 },
    { RC_LLR_DEKU_SCRUB_GROTTO_RIGHT, 40 },
    { RC_LLR_DEKU_SCRUB_GROTTO_CENTER, 40 },
    { RC_DEKU_TREE_MQ_DEKU_SCRUB, 40 },
    { RC_DODONGOS_CAVERN_DEKU_SCRUB_NEAR_BOMB_BAG_LEFT, 40 },
    { RC_DODONGOS_CAVERN_DEKU_SCRUB_SIDE_ROOM_NEAR_DODONGOS, 40 },
    { RC_DODONGOS_CAVERN_DEKU_SCRUB_NEAR_BOMB_BAG_RIGHT, 40 },
    { RC_DODONGOS_CAVERN_DEKU_SCRUB_LOBBY, 40 },
    { RC_DODONGOS_CAVERN_MQ_DEKU_SCRUB_LOBBY_REAR, 40 },
    { RC_DODONGOS_CAVERN_MQ_DEKU_SCRUB_LOBBY_FRONT, 40 },
    { RC_DODONGOS_CAVERN_MQ_DEKU_SCRUB_STAIRCASE, 40 },
    { RC_DODONGOS_CAVERN_MQ_DEKU_SCRUB_SIDE_ROOM_NEAR_LOWER_LIZALFOS, 40 },
    { RC_JABU_JABUS_BELLY_DEKU_SCRUB, 40 },
    { RC_GANONS_CASTLE_DEKU_SCRUB_CENTER_LEFT, 40 },
    { RC_GANONS_CASTLE_DEKU_SCRUB_CENTER_RIGHT, 40 },
    { RC_GANONS_CASTLE_DEKU_SCRUB_RIGHT, 40 },
    { RC_GANONS_CASTLE_DEKU_SCRUB_LEFT, 40 },
    { RC_GANONS_CASTLE_MQ_DEKU_SCRUB_RIGHT, 40 },
    { RC_GANONS_CASTLE_MQ_DEKU_SCRUB_CENTER_LEFT, 40 },
    { RC_GANONS_CASTLE_MQ_DEKU_SCRUB_CENTER, 40 },
    { RC_GANONS_CASTLE_MQ_DEKU_SCRUB_CENTER_RIGHT, 40 },
    { RC_GANONS_CASTLE_MQ_DEKU_SCRUB_LEFT, 40 },
};
            ...
            if (it->is_structured()) {
                ...
                for (auto itemit = itemJson.begin(); itemit != itemJson.end(); ++itemit) {
                    ...
                    if (itemit.key() == "item") {
                        ...
                        if (scrubPrices.find(gSaveContext.itemLocations[index].check) != scrubPrices.end()) {
