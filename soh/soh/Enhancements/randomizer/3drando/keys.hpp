...
typedef enum {
  ...
  //SILVER RUPEES (& Pouches)
  ICE_CAVERN_SPINNING_BLADES_SILVER_RUPEE,
  ICE_CAVERN_SLIDING_SILVER_RUPEE,
  BOTTOM_OF_THE_WELL_SILVER_RUPEE,
  GERUDO_TRAINING_GROUNDS_BOULDER_SILVER_RUPEE,
  GERUDO_TRAINING_GROUNDS_LAVA_SILVER_RUPEE,
  GERUDO_TRAINING_GROUNDS_TOILET_SILVER_RUPEE,
  SPIRIT_CHILD_BLOCK_PUSH_SILVER_RUPEE,
  SPIRIT_BOULDER_SILVER_RUPEE,
  SHADOW_SCYTHE_SILVER_RUPEE,
  SHADOW_OUTSIDE_SPIKE_RAIN_SILVER_RUPEE,
  SHADOW_INVISIBLE_SPIKES_SILVER_RUPEE,
  FOREST_TRIAL_SILVER_RUPEE,
  FIRE_TRIAL_SILVER_RUPEE,
  SPIRIT_TRIAL_SILVER_RUPEE,
  LIGHT_TRIAL_SILVER_RUPEE,
  DODONGOS_CAVERN_MQ_SILVER_RUPEE,
  SPIRIT_MQ_LOBBY_SILVER_RUPEE,
  SHADOW_MQ_INVISIBLE_SCYTHE_SILVER_RUPEE,
  WATER_TRIAL_MQ_SILVER_RUPEE,
  SHADOW_TRIAL_MQ_SILVER_RUPEE,
  ICE_CAVERN_SPINNING_BLADES_SILVER_RUPEE_POUCH,
  ICE_CAVERN_SLIDING_SILVER_RUPEE_POUCH,
  BOTTOM_OF_THE_WELL_SILVER_RUPEE_POUCH,
  GERUDO_TRAINING_GROUNDS_BOULDER_SILVER_RUPEE_POUCH,
  GERUDO_TRAINING_GROUNDS_LAVA_SILVER_RUPEE_POUCH,
  GERUDO_TRAINING_GROUNDS_TOILET_SILVER_RUPEE_POUCH,
  SPIRIT_CHILD_BLOCK_PUSH_SILVER_RUPEE_POUCH,
  SPIRIT_BOULDER_SILVER_RUPEE_POUCH,
  SHADOW_SCYTHE_SILVER_RUPEE_POUCH,
  SHADOW_OUTSIDE_SPIKE_RAIN_SILVER_RUPEE_POUCH,
  SHADOW_INVISIBLE_SPIKES_SILVER_RUPEE_POUCH,
  FOREST_TRIAL_SILVER_RUPEE_POUCH,
  FIRE_TRIAL_SILVER_RUPEE_POUCH,
  SPIRIT_TRIAL_SILVER_RUPEE_POUCH,
  LIGHT_TRIAL_SILVER_RUPEE_POUCH,
  DODONGOS_CAVERN_MQ_SILVER_RUPEE_POUCH,
  SPIRIT_MQ_LOBBY_SILVER_RUPEE_POUCH,
  SHADOW_MQ_INVISIBLE_SCYTHE_SILVER_RUPEE_POUCH,
  WATER_TRIAL_MQ_SILVER_RUPEE_POUCH,
  SHADOW_TRIAL_MQ_SILVER_RUPEE_POUCH,
