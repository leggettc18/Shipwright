...
ItemObtainability Randomizer::GetItemObtainabilityFromRandomizerGet(RandomizerGet randoGet) {
    ...
    switch (randoGet) {
        ...
        case RG_ICE_CAVERN_SPINNING_BLADES_SILVER_RUPEE: // for convenience
        ...
        case RG_ICE_CAVERN_SPINNING_BLADES_SILVER_RUPEE_POUCH:
        case RG_ICE_CAVERN_SLIDING_SILVER_RUPEE_POUCH:
        case RG_BOTTOM_OF_THE_WELL_SILVER_RUPEE_POUCH:
        case RG_GERUDO_TRAINING_GROUNDS_BOULDER_SILVER_RUPEE_POUCH:
        case RG_GERUDO_TRAINING_GROUNDS_LAVA_SILVER_RUPEE_POUCH:
        case RG_GERUDO_TRAINING_GROUNDS_TOILET_SILVER_RUPEE_POUCH:
        case RG_SPIRIT_CHILD_BLOCK_PUSH_SILVER_RUPEE_POUCH:
        case RG_SPIRIT_BOULDER_SILVER_RUPEE_POUCH:
        case RG_SHADOW_SCYTHE_SILVER_RUPEE_POUCH:
        case RG_SHADOW_OUTSIDE_SPIKE_RAIN_SILVER_RUPEE_POUCH:
        case RG_SHADOW_INVISIBLE_SPIKES_SILVER_RUPEE_POUCH:
        case RG_FOREST_TRIAL_SILVER_RUPEE_POUCH:
        case RG_FIRE_TRIAL_SILVER_RUPEE_POUCH:
        case RG_SPIRIT_TRIAL_SILVER_RUPEE_POUCH:
        case RG_LIGHT_TRIAL_SILVER_RUPEE_POUCH:
        case RG_DODONGOS_CAVERN_MQ_SILVER_RUPEE_POUCH:
        case RG_SPIRIT_MQ_LOBBY_SILVER_RUPEE_POUCH:
        case RG_SHADOW_MQ_INVISIBLE_SCYTHE_SILVER_RUPEE_POUCH:
        case RG_WATER_TRIAL_MQ_SILVER_RUPEE_POUCH:
        case RG_SHADOW_TRIAL_MQ_SILVER_RUPEE_POUCH:
            return this->randoContext->IsSilverRupeePuzzleComplete(randoGet)
...
void InitRandoItemTable() {
    ...
    static GetItemEntry randoGetItemTable[] = {
        ...
        GET_ITEM(RG_ICE_CAVERN_SPINNING_BLADES_SILVER_RUPEE,            OBJECT_GI_RUPY,  GID_RUPEE_GOLD,   TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_SMALL_KEY, MOD_RANDOMIZER, RG_ICE_CAVERN_SPINNING_BLADES_SILVER_RUPEE),
        GET_ITEM(RG_ICE_CAVERN_SLIDING_SILVER_RUPEE,                    OBJECT_GI_RUPY,  GID_RUPEE_GOLD,   TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_SMALL_KEY, MOD_RANDOMIZER, RG_ICE_CAVERN_SLIDING_SILVER_RUPEE),
        ...
        GET_ITEM(RG_SHADOW_MQ_INVISIBLE_SCYTHE_SILVER_RUPEE,            OBJECT_GI_RUPY,  GID_RUPEE_GOLD,   TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_SMALL_KEY, MOD_RANDOMIZER, RG_SHADOW_MQ_INVISIBLE_SCYTHE_SILVER_RUPEE),
        GET_ITEM(RG_WATER_TRIAL_MQ_SILVER_RUPEE,                        OBJECT_GI_RUPY,  GID_RUPEE_GOLD,   TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_SMALL_KEY, MOD_RANDOMIZER, RG_WATER_TRIAL_MQ_SILVER_RUPEE),
        GET_ITEM(RG_SHADOW_TRIAL_MQ_SILVER_RUPEE,                       OBJECT_GI_RUPY,  GID_RUPEE_GOLD,   TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_SMALL_KEY, MOD_RANDOMIZER, RG_SHADOW_TRIAL_MQ_SILVER_RUPEE),
        GET_ITEM(RG_ICE_CAVERN_SPINNING_BLADES_SILVER_RUPEE_POUCH,      OBJECT_GI_PURSE, GID_WALLET_ADULT, TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_SMALL_KEY, MOD_RANDOMIZER, RG_ICE_CAVERN_SPINNING_BLADES_SILVER_RUPEE_POUCH),
        GET_ITEM(RG_ICE_CAVERN_SLIDING_SILVER_RUPEE_POUCH,              OBJECT_GI_PURSE, GID_WALLET_ADULT, TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_SMALL_KEY, MOD_RANDOMIZER, RG_ICE_CAVERN_SLIDING_SILVER_RUPEE_POUCH),
        ...
        GET_ITEM(RG_SHADOW_MQ_INVISIBLE_SCYTHE_SILVER_RUPEE_POUCH,      OBJECT_GI_PURSE, GID_WALLET_ADULT, TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_SMALL_KEY, MOD_RANDOMIZER, RG_SHADOW_MQ_INVISIBLE_SCYTHE_SILVER_RUPEE_POUCH),
        GET_ITEM(RG_WATER_TRIAL_MQ_SILVER_RUPEE_POUCH,                  OBJECT_GI_PURSE, GID_WALLET_ADULT, TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_SMALL_KEY, MOD_RANDOMIZER, RG_WATER_TRIAL_MQ_SILVER_RUPEE_POUCH),
        GET_ITEM(RG_SHADOW_TRIAL_MQ_SILVER_RUPEE_POUCH,                 OBJECT_GI_PURSE, GID_WALLET_ADULT, TEXT_RANDOMIZER_CUSTOM_ITEM, 0x80, CHEST_ANIM_LONG,  ITEM_CATEGORY_SMALL_KEY, MOD_RANDOMIZER, RG_SHADOW_TRIAL_MQ_SILVER_RUPEE_POUCH),
    };
