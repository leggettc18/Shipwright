...
std::array<GSActor, NUM_CUSTOM_GS_ACTORS> customGSActors = {
  ...
  GSActor(SCENE_KAKARIKO_VILLAGE, LINK_AGE_ADULT, RAND_INF_CGS_KAK_WINDMILL, RC_CGS_KAK_WINDMILL, {1297, 902, 631}, {0, 0, 0}, 0xB100),
  GSActor(SCENE_OUTSIDE_GANONS_CASTLE, LINK_AGE_ADULT, RAND_INF_CGS_OGC_BEHIND_OBELISK, RC_CGS_OGC_BEHIND_OBELISK, {3008, 1400, 515}, {0, 0, 0}, 0x8F00)
};
