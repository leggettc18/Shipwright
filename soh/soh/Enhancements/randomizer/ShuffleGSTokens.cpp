...
std::array<GSActor, NUM_CUSTOM_GS_ACTORS> customGSActors = {
  ...
  GSActor(SCENE_KOKIRI_FOREST, LINK_AGE_ADULT, 1, RAND_INF_KF_CGS_BEHIND_DEKU_TREE_ADULT, RC_KF_CGS_BEHIND_DEKU_TREE_ADULT, { 4855, -154, -2182 }, {0, 0, 0}, 0xAD00),
  GSActor(SCENE_KOKIRI_FOREST, LINK_AGE_CHILD, 2, RAND_INF_KF_CGS_BOULDER_MAZE, RC_KF_CGS_BOULDER_MAZE, {-233, 280, 2335}, {0, 0, 0}, 0xAD00),
  GSActor(SCENE_KOKIRI_FOREST, LINK_AGE_CHILD, 0, RAND_INF_KF_CGS_BEAN_ALCOVE, RC_KF_CGS_BEAN_ALCOVE, { 1305, 300, -480 }, {0, 0, 0}, 0xAD00),
  GSActor(SCENE_KOKIRI_FOREST, LINK_AGE_CHILD, 0, RAND_INF_KF_CGS_BEHIND_SHOP_CHILD, RC_KF_CGS_BEHIND_SHOP_CHILD, {657, 200, -659}, {0, 0, 0}, 0xAD00),
  GSActor(SCENE_KOKIRI_FOREST, LINK_AGE_ADULT, 0, RAND_INF_KF_CGS_BEHIND_SHOP_ADULT, RC_KF_CGS_BEHIND_SHOP_ADULT, {657, 200, -659}, {0, 0, 0}, 0xAD00),
  GSActor(SCENE_KOKIRI_FOREST, LINK_AGE_CHILD, 0, RAND_INF_KF_CGS_CLIFF_NEAR_LW_CHILD, RC_KF_CGS_CLIFF_NEAR_LW_CHILD, {-702, 320, -1138}, {0, 0, 0}, 0xAD00),
  GSActor(SCENE_KOKIRI_FOREST, LINK_AGE_ADULT, 0, RAND_INF_KF_CGS_CLIFF_NEAR_LW_ADULT, RC_KF_CGS_CLIFF_NEAR_LW_ADULT, {-702, 320, -1138}, {0, 0, 0}, 0xAD00),
  GSActor(SCENE_KOKIRI_FOREST, LINK_AGE_CHILD, 0, RAND_INF_KF_CGS_WATERFALL_CHILD, RC_KF_CGS_WATERFALL_CHILD, {400, 250, -512}, {0, 0, 0}, 0xAD00),
  GSActor(SCENE_KOKIRI_FOREST, LINK_AGE_ADULT, 0, RAND_INF_KF_CGS_WATERFALL_ADULT, RC_KF_CGS_WATERFALL_ADULT, {400, 250, -512}, {0, 0, 0}, 0xAD00),
