...
typedef enum {
    ...
    RG_SILVER_RUPEE_LAST = RG_SHADOW_MQ_INVISIBLE_SCYTHE_SILVER_RUPEE, // for convenience
    ...
    RG_SILVER_RUPEE_POUCH_LAST = RG_SHADOW_MQ_INVISIBLE_SCYTHE_SILVER_RUPEE_POUCH, // for convenience
    RG_MAX
} RandomizerGet;
